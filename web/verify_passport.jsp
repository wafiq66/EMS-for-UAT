        ...
        <section class="container">
            ...
            <form action="register_employee.do" class="form" method="post">
            	<div class="input-box">
                	...
                	<input type="text" placeholder="Enter passport number" name="employeePassportNumber" pattern="[A-Z][0-9]{7}" title="Please enter a passport number in the format: A1234567" required/>
            	</div>
